...
Figure \ref{fig:runtimes-by-blanks} shows the average run-time grouped by the number of blank cells. Similar to the box plot shown earlier, the run-time tends to increase as the number of blank cells increases. The smallest number of blank cells in the dataset is 36. Interestingly, the lowest average run-time, 6 ms, is observed for puzzles with 37 blank cells. The largest number of blank cells is 60, and such puzzles exhibit the highest average run-time of 4,787.8 ms.
