...
\newpage
This thesis explores whether Bird’s approach can be applied to Str8ts, a puzzle similar to Sudoku. See Figure~\ref{fig:grid-comparison-sudoku-str8ts} for a side-by-side comparison. We also aim to present our work in the very unique style of a \textit{Functional Pearl}. Bird’s guide, \textit{How to Write a Functional Pearl}, gives advise such as "Throw away the rule book for writing research papers", "Be engaging", and "You are telling a story, so some element of surprise is welcome". Functional Pearls are characterized as polished, elegant, instructive, and entertaining. Qualities we strive to achieve~\cite{Bi06}.
