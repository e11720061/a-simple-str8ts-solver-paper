...
In theory, a Str8ts puzzle can have multiple solutions, a single solution, or none at all. However, the official website guarantees that all published puzzles have a unique solution that can be reached purely through logical reasoning, without the need for guessing. In this paper, we focus on the classical version of Str8ts, which is played on a $9 \times 9$ grid. However, we will design the algorithm to adapt to different grid sizes by adjusting a single parameter.